...
function capturePage(st){
	...
	page.open('http://projects:8080/home/alec/Projects/Brookings/congressional-district-poverty/index.html#'+st, function() {
		console.log(st + " page loaded");
	});
}

for(var s=0; s<states.length; s++){
	if(s<51){
		console.log("Rendering " + states[s].STATE_NAME);
		capturePage(states[s].STUSAB);
	}
	else{
		console.log("Not rendering " + states[s].STATE_NAME);
	}
